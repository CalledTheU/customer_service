...
from seeyon.knowledge.provider import KnowledgeChunk, KnowledgeProvider
...
class KnowledgeHanlder:
    ...
    """
        1 获取意图识别结果 list[str]  ['flow_info' ,'leave_policy']
    ...
    async def handle(self, know_intents: list[str],
        ...
        # 1获取意图识别结果
        # list[str] ['flow_info', 'leave_policy']
        # 2根据意图识别结果
        ...
        # 获取答案位置  根据 ['flow_info', 'leave_policy']
        # provider_ids ，去重操作
