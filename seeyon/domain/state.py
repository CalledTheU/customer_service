...
from seeyon.task.lifecycle.models import TaskEvent, TaskSwitched, TaskStarted, TaskCanceled, TaskRef
...
class TaskInstance:
    ...
    # 槽位数据字典  {flow_number : QJ20260901001}
